...
as
    procedure do_resolve (
            the_owner        in out varchar2 ,
            the_object       in out varchar2 ,
            a_procedure_name in out varchar2 )
    is
        name          varchar2 ( 200 ) ;
        context       integer;
        dblink        varchar2 ( 200 ) ;
    ...
    begin
        ...
        context := 1; --plsql
        dbms_utility.name_resolve ( name => name ,context => context ,schema => the_owner ,part1 => the_object ,part2 => a_procedure_name ,dblink => dblink ,part1_type => part1_type ,object_number => object_number ) ;
    end do_resolve;
    function form_name (
