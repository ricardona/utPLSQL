...
as
    function form_name (
            ...
            a_object     varchar2 ,
            a_subprogram varchar2 default null )
        return varchar2
    is
        name varchar2 ( 200 ) ;
    begin
    ...
    begin
        ...
        dbms_utility.name_resolve ( name => name ,context => 1 -- pl/sql
        ,schema => schema ,part1 => part1 ,part2 => part2 ,dblink => dblink ,part1_type => part1_type ,object_number => object_number ) ;
         select count ( * )
           into v_cnt
           from all_objects
          where owner        = schema
    ...
    function do_resolve (
            ...
            the_object      in varchar2 ,
            a_procedurename in varchar2 )
        return boolean
    is
        name          varchar2 ( 200 ) ;
        context       integer;
    ...
    begin
        ...
        context := 1; --plsql
        begin
            dbms_utility.name_resolve ( name => name ,context => context ,schema => schema ,part1 => part1 ,part2 => part2 ,dblink => dblink ,part1_type => part1_type ,object_number => object_number ) ;
        exception
        when others then
