create or replace package ut_reporter_execution as
  ...
  procedure end_test(a_reporter in ut_suite_reporter, a_test in ut_single_test, a_result ut_execution_result, a_in_suite in boolean);
  ...
  procedure end_test(a_reporters in ut_suite_reporters, a_test in ut_single_test, a_result ut_execution_result, a_in_suite in boolean);
end;
/
