...
(
  ...
  overriding member procedure begin_test(self in ut_dbms_output_suite_reporter, a_test in ut_single_test, a_in_suite in boolean),
  overriding member procedure end_test(self in ut_dbms_output_suite_reporter, a_test in ut_single_test, a_in_suite in boolean)
)
/
