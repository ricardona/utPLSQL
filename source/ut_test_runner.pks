create or replace package ut_test_runner as
  ...
  */
  ...
  procedure execute_test(a_test in ut_single_test, a_reporters in ut_suite_reporters, a_results out ut_execution_result, a_in_suite in boolean default false);
  procedure execute_test(a_test in ut_single_test, a_results out ut_execution_result, a_in_suite in boolean default false);
  procedure execute_test(a_test in ut_single_test, a_in_suite in boolean default false);
