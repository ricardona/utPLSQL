create or replace package body ut_test_runner as
  ...
  procedure execute_test(a_test in ut_single_test, a_reporters in ut_suite_reporters, a_results out ut_execution_result, a_in_suite in boolean default false) as
  begin
  ...
  procedure execute_test(a_test in ut_single_test, a_results out ut_execution_result, a_in_suite in boolean default false) as
  begin
    setup_default_reporters;
    execute_test(a_test, defaultreporters, a_results, a_in_suite);
  end;

  procedure execute_test(a_test in ut_single_test, a_in_suite in boolean default false) as
